...
/**
 * @brief PTP (IEEE 1588) Registers in DM9051
 *
 */
#define DM9051_PTPCR (0x60)    // PTP Control Register
#define DM9051_PTPCCR (0x61)   // PTP Clock Control Register
#define DM9051_PTPOSCR (0x62)  // PTP One Step Control Register
#define DM9051_PTPTXCR (0x63)  // PTP TX Control Register
#define DM9051_PTPMSR (0x64)   // PTP Master/Slave & Version Register
#define DM9051_PTPDELR1 (0x65) // PTP Delay Register 1
#define DM9051_PTPDELR2 (0x66) // PTP Delay Register 2
#define DM9051_PTPTSR (0x67)   // PTP Timestamp Status Register
#define DM9051_PTPDIDR (0x68)  // PTP Data Input/Output Register
#define DM9051_PTPIDXR (0x69)  // PTP Index Register

/**
 * @brief PTP Control Register (0x60) Bits
 */
#define PTPCR_RESTART (1 << 0) // PTP Restart

/**
 * @brief PTP Clock Control Register (0x61) Bits
 */
#define PTPCCR_IDX_RESET (1 << 7)    // Reset Index Pointer
#define PTPCCR_READ_TIME (1 << 2)    // Read PTP Clock Time
#define PTPCCR_WRITE_TIME_OFFSET (1 << 4) // Write Time Offset
#define PTPCCR_WRITE_TIME (1 << 3)   // Write PTP Clock Time
#define PTPCCR_PTP_ENABLE (1 << 0)   // PTP Enable
#define PTPCCR_RATE_SLOWER (0x60)    // Rate Adjust Slower
#define PTPCCR_RATE_FASTER (0x20)    // Rate Adjust Faster

/**
 * @brief PTP Master/Slave & Version Register (0x64) Bits
 */
#define PTPMSR_RX_EN (1 << 4)     // PTP RX Enable
#define PTPMSR_MULTICAST (1 << 1) // PTP Multicast Enable

/**
 * @brief PTP Constants
 */
#define DM9051_PTP_CLOCK_HZ 25000000UL // 25 MHz PTP clock
#define DM9051_PTP_ADJ_FREQ_BASE_ADDEND 171.7987 // Base addend for frequency adjustment (2^32 * 1ppb / 25MHz)
#define DM9051_PTP_MAX_ADJUSTMENT 0xEFFFFFFF // Maximum adjustment value
